...
ggplot(train,aes(x=SAG_dif,fill=as.factor(result)))+geom_density()
ggplot(train,aes(x=MOR_dif,fill=as.factor(result)))+geom_density()
ggplot(train,aes(x=DOK_dif,fill=as.factor(result)))+geom_density()
